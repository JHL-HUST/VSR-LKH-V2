...
void PrintStatistics()
{
    ...
    FILE* pp;
    pp = fopen("11111TSP-results.xls", "a+");
    ...
    fprintf(pp, "%d\t%d\t%0.1f\t%d\t%d\t%0.2f\t%0.1f\n", tttype, CostMin, (double) CostSum / _Runs, CostMax, Successes, fabs(TimeSum) / _Runs, 1.0 * TrialSum / _Runs);
    fclose(pp);
}
